...
use crate::flatbuffers::protocol_generated::protocol::{
    ...
    GetBlocks as FlatBuffersGetBlocks, GetBlocksArgs, GetData as FlatBuffersGetData, GetDataArgs,
    GetPeers as FlatBuffersGetPeers, GetPeersArgs, Hash as FlatBuffersHash,
    HashArgs as FlatBuffersHashArgs, HashArgs, HashType as FlatBuffersHashType,
    Inv as FlatBuffersInv, InvArgs, InvVector as FlatBuffersInvVector, InvVectorArgs,
...
fn create_get_data_flatbuffer(
    ...
    // Create vector of flatbuffers' inv vectors
    let ftb_inv_vectors: Vec<flatbuffers::WIPOffset<FlatBuffersInvVector>> = get_data_args
        .inventory
        .iter()
        .map(|inv_vector: &InvVector| {
            // Create flatbuffers' hash bytes
