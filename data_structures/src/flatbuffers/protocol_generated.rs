...
impl<'a> Message<'a> {
  ...
  pub fn command_as_version(&'a self) -> Option<Version> {
    if self.command_type() == Command::Version {
      self.command().map(|u| Version::init_from_table(u))
    } else {
      None
    }
  }
  ...
  pub fn command_as_verack(&'a self) -> Option<Verack> {
    if self.command_type() == Command::Verack {
      self.command().map(|u| Verack::init_from_table(u))
    } else {
      None
    }
  }
  ...
  pub fn command_as_get_peers(&'a self) -> Option<GetPeers> {
    if self.command_type() == Command::GetPeers {
      self.command().map(|u| GetPeers::init_from_table(u))
    } else {
      None
    }
  }
  ...
  pub fn command_as_peers(&'a self) -> Option<Peers> {
    if self.command_type() == Command::Peers {
      self.command().map(|u| Peers::init_from_table(u))
    } else {
      None
    }
  }
  ...
  pub fn command_as_ping(&'a self) -> Option<Ping> {
    if self.command_type() == Command::Ping {
      self.command().map(|u| Ping::init_from_table(u))
    } else {
      None
    }
  }
  ...
  pub fn command_as_pong(&'a self) -> Option<Pong> {
    if self.command_type() == Command::Pong {
      self.command().map(|u| Pong::init_from_table(u))
    } else {
      None
    }
  }
...
impl<'a> Address<'a> {
  ...
  #[inline]
  pub fn ip_type(&'a self) -> IpAddress {
    self._tab.get::<IpAddress>(Address::VT_IP_TYPE, Some(IpAddress::NONE)).unwrap()
  }
  #[inline]
  pub fn ip(&'a self) -> Option<flatbuffers::Table<'a>> {
...
impl<'a> Version<'a> {
  ...
  #[inline]
  pub fn sender_address(&'a self) -> Option<Address<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Address<'a>>>(Version::VT_SENDER_ADDRESS, None)
  }
  #[inline]
  pub fn receiver_address(&'a self) -> Option<Address<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Address<'a>>>(Version::VT_RECEIVER_ADDRESS, None)
  }
  #[inline]
  pub fn user_agent(&'a self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Version::VT_USER_AGENT, None)
  }
  #[inline]
  pub fn last_epoch(&'a self) -> u32 {
    self._tab.get::<u32>(Version::VT_LAST_EPOCH, Some(0)).unwrap()
  }
  #[inline]
  pub fn genesis(&'a self) -> u64 {
    self._tab.get::<u64>(Version::VT_GENESIS, Some(0)).unwrap()
  }
  #[inline]
  pub fn nonce(&'a self) -> u64 {
...
impl<'a> Peers<'a> {
  ...
  #[inline]
  pub fn peers(&'a self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Address<'a>>>> {
