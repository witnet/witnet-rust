...
mod tests {
    ...
    fn build_drt_example() {
        ...
        let expected = r#"{"dro":{"pkh":"0000000000000000000000000000000000000000","data_request":{"not_before":0,"retrieve":[],"aggregate":{"script":[]},"consensus":{"script":[]},"deliver":[]},"value":0,"witnesses":0,"backup_witnesses":0,"commit_fee":0,"reveal_fee":0,"tally_fee":0,"time_lock":0},"fee":0}"#;
        assert_eq!(s, expected, "\n{}\n", s);
    }
}
