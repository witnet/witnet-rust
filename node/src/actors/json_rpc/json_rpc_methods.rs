...
mod tests {
    ...
    fn build_drt_example() {
        ...
        let expected = r#"{"dro":{"data_request":{"time_lock":0,"retrieve":[],"aggregate":{"filters":[],"reducer":0},"tally":{"filters":[],"reducer":0}},"witness_reward":0,"witnesses":0,"backup_witnesses":0,"commit_fee":0,"reveal_fee":0,"tally_fee":0,"extra_reveal_rounds":0,"min_consensus_percentage":0},"fee":0}"#;
        assert_eq!(s, expected, "\n{}\n", s);
    }
}
