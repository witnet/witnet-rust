...
impl RadManager {
    /// Run retrieval and aggregation stages, asynchronously
    pub fn resolve_ra(
        &mut self,
        msg: ResolveRA,
    ) -> ResponseFuture<RadonReport<RadonTypes>, RadError> {
    ...
    /// Run tally stage and construct `RadonReport`
    pub fn run_tally(&mut self, msg: RunTally) -> RadonReport<RadonTypes> {
