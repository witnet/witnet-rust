...
pub struct Mining {
    ...
    /// Minimum collateral to reward ratio to resolve a data request (reward/collateral * 1000)
    #[partial_struct(serde(default, rename = "minimum_vtt_fee_nanowits"))]
    pub minimum_reward_to_collateral_ratio: u64,
}
...
impl Mining {
    pub fn from_partial(config: &PartialMining, defaults: &dyn Defaults) -> Self {
        Mining {
            ...
            minimum_reward_to_collateral_ratio: config
                .minimum_reward_to_collateral_ratio
                .to_owned()
                .unwrap_or_else(|| defaults.minimum_reward_to_collateral_ratio()),
        }
    }
    ...
    pub fn to_partial(&self) -> PartialMining {
        PartialMining {
            ...
            minimum_reward_to_collateral_ratio: Some(self.minimum_reward_to_collateral_ratio),
        }
    }
}
