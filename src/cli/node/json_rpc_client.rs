...
use witnet_data_structures::{
    chain::{
        ...
        Hashable, InventoryItem, KeyedSignature, MixedOutput, NodeStats, OutputPointer, PublicKey,
        PublicKeyHash, ScriptHash, ScriptInput, ScriptOutput, StateMachine, SupplyInfo, SyncStatus,
        ValueTransferOutput,
    },
